...
Write-Host "Run smoke test: cd demos\agent-contaminant-investigation\src; .\smoke-test.ps1"
Write-Host "Portfolio page (if Jekyll running): http://127.0.0.1:4000/portfolio/agent-contaminant-investigation.html"
