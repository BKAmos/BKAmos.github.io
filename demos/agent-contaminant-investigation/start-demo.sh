...
echo "Run smoke test: cd demos/agent-contaminant-investigation && ./verify-demo.sh"
echo "Portfolio page (if Jekyll running): http://127.0.0.1:4000/portfolio/agent-contaminant-investigation.html"
